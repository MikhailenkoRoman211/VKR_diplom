"""
lgb_tuner.py  —  автоматический подбор гиперпараметров LightGBM через Optuna.

Результат:
  • best_params.pkl – словарь лучших параметров
  • печать лучшего R² на валидации

Запуск в PyCharm
----------------
1. Откройте файл, нажмите  ▶  (Run).
2. Чтобы поменять количество попыток, создайте Run-Configuration:
      Script parameters: --trials 100
   или просто отредактируйте DEFAULT_TRIALS ниже.
"""
...
DEFAULT_TRIALS = 50      # если не указан --trials


# ------------------------------------------------------------------
def build_dataset(start="2015-01-01", end="2021-12-31"):
    """Быстрый датасет для тюнинга — ~6 лет дневных данных листинга 1."""
